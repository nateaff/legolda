...
With this set up we can apply other text mining techniques that don't rely only on word frequency and not word order. For example, in some exploratory plots I use the TF-IDF score to plot uncommon and common color-set combinations.

Part of the purpose of this project was to try out the text analysis techniques in Julia Silge and David Robinson's [Text Mining with R](tidytextmining.com) book. A good deal of the code is simply an adaptation of theirs. 
